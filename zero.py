{
  ...
  "metadata": {
    "colab": {
      "provenance": [],
      "mount_file_id": "1sbmdBCJFuZym878v3pXgHtrDezvCLa6h",
      "authorship_tag": "ABX9TyNAggtYOB2/3jdnT6ZR26Vm",
  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/marcohartung77/Zero_Classification/blob/main/zero.py\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "code",
